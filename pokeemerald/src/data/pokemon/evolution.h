const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_METAPOD]    = {{EVO_LEVEL, 10, SPECIES_KAKUNA}},
    [SPECIES_WEEDLE]     = {{EVO_LEVEL,  7, SPECIES_KAKUNA}},
    [SPECIES_KAKUNA]     = {{EVO_LEVEL, 20, SPECIES_BEEDRILL}},
    [SPECIES_BEEDRILL]     = {{EVO_LEVEL, 21, SPECIES_METAPOD}},
    ...
    [SPECIES_NIDORINA]   = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDORINO}},
    [SPECIES_NIDORAN_M]  = {{EVO_LEVEL, 16, SPECIES_NIDORINO}},
    [SPECIES_NIDORINO]   = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDORINA}},
    ...
    [SPECIES_ZUBAT]      = {{EVO_LEVEL, 22, SPECIES_CROBAT}},
    ...
    [SPECIES_ABRA]       = {{EVO_LEVEL, 16, SPECIES_ALAKAZAM}},
    ...
    [SPECIES_MAGIKARP]   = {{EVO_LEVEL, 20, SPECIES_DRAGONITE}},
    ...
    [SPECIES_DRAGONAIR]  = {{EVO_LEVEL, 55, SPECIES_GYARADOS}},
    ...
    [SPECIES_ZIGZAGOON]  = {{EVO_LEVEL, 20, SPECIES_ZANGOOSE}},
