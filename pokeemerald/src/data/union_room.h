...
ALIGNED(4) static const u8 sText_BattleDeclinedMale[] = _("Sorry! My ANIMALS don't seem to\nbe feeling too well right now.\lLet me battle you another time.\p");
ALIGNED(4) static const u8 sText_BattleDeclinedFemale[] = _("I'm terribly sorry, but my ANIMALS\naren't feeling well…\pLet's battle another time.\p");
...
ALIGNED(4) static const u8 sText_SwitchedMonsMale[] = _("Oh! How could you use that\nANIMALS in that situation?\p");
ALIGNED(4) static const u8 sText_YoureToughFemale[] = _("That ANIMALS…\nIt's been raised really well!\p");
...
ALIGNED(4) static const u8 sText_MaleTraded1[] = _("Yeahah!\nI really wanted this ANIMALS!\p");
ALIGNED(4) static const u8 sText_MaleTraded2[] = _("Finally, a trade got me that\nANIMALS I'd wanted a long time.\p");
ALIGNED(4) static const u8 sText_FemaleTraded1[] = _("I'm trading ANIMALS right now.\p");
ALIGNED(4) static const u8 sText_FemaleTraded2[] = _("I finally got that ANIMALS I\nwanted in a trade!\p");
...
ALIGNED(4) static const u8 sText_RegisterMonAtTradingBoard[] = _("Welcome to the TRADING BOARD.\pYou may register your ANIMALS\nand offer it up for a trade.\pWould you like to register one of\nyour ANIMALS?");
ALIGNED(4) static const u8 sText_TradingBoardInfo[] = _("This TRADING BOARD is used for\n"
                                                        "offering a ANIMALS for a trade.\p"
                                                        "All you need to do is register a\n"
                                                        "ANIMALS for a trade.\p"
                                                        "Another TRAINER may offer a party\n"
                                                        "ANIMALS in return for the trade.\p"
                                                        "We hope you will register ANIMALS\n"
                                                        "and trade them with many, many\l"
                                                        "other TRAINERS.\p"
                                                        "Would you like to register one of\nyour ANIMALS?");
ALIGNED(4) static const u8 sText_ThankYouForRegistering[] = _("We have registered your ANIMALS for\ntrade on the TRADING BOARD.\pThank you for using this service!\p"); // unused
ALIGNED(4) static const u8 sText_NobodyHasRegistered[] = _("Nobody has registered any ANIMALS\nfor trade on the TRADING BOARD.\p\n"); // unused
ALIGNED(4) static const u8 sText_ChooseRequestedMonType[] = _("Please choose the type of ANIMALS\nthat you would like in the trade.\n");
ALIGNED(4) static const u8 sText_WhichMonWillYouOffer[] = _("Which of your party ANIMALS will\nyou offer in trade?\p");
...
ALIGNED(4) static const u8 sText_ChooseLeaderPokemonJump[] = _("Jump with mini ANIMALS!\nPlease choose the LEADER.");
...
ALIGNED(4) static const u8 sText_PokemonTrades[] = _("ANIMALS TRADES");
...
ALIGNED(4) static const u8 sText_PokemonJump[] = _("ANIMALS JUMP");
