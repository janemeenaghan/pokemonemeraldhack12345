const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_COMET_PUNCH] = _("COMMIT PUNCH"),
    [MOVE_MEGA_PUNCH] = _("FRUIT PUNCH"),
    [MOVE_PAY_DAY] = _("PAY DAY"),
    [MOVE_FIRE_PUNCH] = _("HOT PUNCH"),
    [MOVE_ICE_PUNCH] = _("COLD PUNCH"),
    [MOVE_THUNDER_PUNCH] = _("YELLOW PUNCH"),
    [MOVE_SCRATCH] = _("TRUE SWIPE"),
    ...
    [MOVE_BIND] = _("BIND"),
    [MOVE_SLAM] = _("SLAM"),
    [MOVE_VINE_WHIP] = _("HELICOPTER"),
    [MOVE_STOMP] = _("CBT AND BALL"),
    [MOVE_DOUBLE_KICK] = _("DOUBLE KICK"),
    [MOVE_MEGA_KICK] = _("FRUIT KICK"),
    [MOVE_JUMP_KICK] = _("HI JUMP KICK"),
    [MOVE_ROLLING_KICK] = _("TORQUE KICK"),
    [MOVE_SAND_ATTACK] = _("SAND-ATTACK"),
    [MOVE_HEADBUTT] = _("BUTTHEAD"),
    [MOVE_HORN_ATTACK] = _("FURY ATTACK"),
    [MOVE_FURY_ATTACK] = _("HORN ATTACK"),
    [MOVE_HORN_DRILL] = _("HORN FURY"),
    ...
    [MOVE_TWINEEDLE] = _("TWIN NEEDLE"),
    [MOVE_PIN_MISSILE] = _("PIN MISSILE"),
    [MOVE_LEER] = _("LEER"),
    [MOVE_BITE] = _("CHEW"),
    [MOVE_GROWL] = _("GROWL"),
    [MOVE_ROAR] = _("DISTORTGROWL"),
    [MOVE_SING] = _("SING"),
    ...
    [MOVE_QUICK_ATTACK] = _("ATTACK QUICK"),
    [MOVE_RAGE] = _("DRAGON RAGE"),
    [MOVE_TELEPORT] = _("TELEPORT"),
    [MOVE_NIGHT_SHADE] = _("NIGHT SHADE"),
    [MOVE_MIMIC] = _("MIMIC"),
    [MOVE_SCREECH] = _("SCREECH"),
    [MOVE_DOUBLE_TEAM] = _("TEAM"),
    ...
    [MOVE_EGG_BOMB] = _("IMPREGNATE"),
    [MOVE_LICK] = _("LICK"),
    [MOVE_SMOG] = _("SMOG"),
    [MOVE_SLUDGE] = _("lol"),
    [MOVE_BONE_CLUB] = _("BONE CLUB"),
    [MOVE_FIRE_BLAST] = _("FYRBALJUTSU"),
    [MOVE_WATERFALL] = _("CRASHER WAKE"),
    [MOVE_CLAMP] = _("NIPPLE CLAMP"),
    [MOVE_SWIFT] = _("TAYLOR SWIFT"),
    [MOVE_SKULL_BASH] = _("BUTTHEAD2"),
    ...
    [MOVE_DESTINY_BOND] = _("DISNYCHNLFLO"),
    [MOVE_PERISH_SONG] = _("EVERYDAYBRO"),
    ...
    [MOVE_PAIN_SPLIT] = _("EMPATH"),
    [MOVE_SACRED_FIRE] = _("SACRED FIRE"),
    [MOVE_MAGNITUDE] = _("MAGNITUDE"),
    [MOVE_DYNAMIC_PUNCH] = _("DRUNKEN FIST"),
    ...
    [MOVE_FOCUS_PUNCH] = _("CONC PUNCH"),
    [MOVE_SMELLING_SALT] = _("SMELLINGSALT"),
    [MOVE_FOLLOW_ME] = _("DRACO METEOR"),
    ...
    [MOVE_LUSTER_PURGE] = _("TWIN TOWER"),
    ...
    [MOVE_WATER_SPOUT] = _("UP WATER GUN"),
    [MOVE_SIGNAL_BEAM] = _("SIGNAL BEAM"),
    [MOVE_SHADOW_PUNCH] = _("DISTORTPUNCH"),
    ...
    [MOVE_DOOM_DESIRE] = _("DEATH DRIVE"),
