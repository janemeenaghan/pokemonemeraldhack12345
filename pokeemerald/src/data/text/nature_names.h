static const u8 sHardyNatureName[] = _("NORMY");
static const u8 sLonelyNatureName[] = _("DOOMER");
static const u8 sBraveNatureName[] = _("BRAVE");
static const u8 sAdamantNatureName[] = _("YASS");
static const u8 sNaughtyNatureName[] = _("NAUGHTY");
static const u8 sBoldNatureName[] = _("BOLD");
static const u8 sDocileNatureName[] = _("BREEDABLE");
static const u8 sRelaxedNatureName[] = _("RELAXED");
static const u8 sImpishNatureName[] = _("IMPISH");
static const u8 sLaxNatureName[] = _("HASTY");
static const u8 sTimidNatureName[] = _("TIMID");
static const u8 sHastyNatureName[] = _("LAX");
static const u8 sSeriousNatureName[] = _("JOLLY");
static const u8 sJollyNatureName[] = _("SERIOUS");
static const u8 sNaiveNatureName[] = _("NAIVE");
static const u8 sModestNatureName[] = _("ADAMANT");
static const u8 sMildNatureName[] = _("AUTISTIC");
static const u8 sQuietNatureName[] = _("QUIET");
static const u8 sBashfulNatureName[] = _("BASHFUL");
static const u8 sRashNatureName[] = _("ASPIE");
static const u8 sCalmNatureName[] = _("CALM");
static const u8 sGentleNatureName[] = _("GENTLE");
static const u8 sSassyNatureName[] = _("SLAY");
