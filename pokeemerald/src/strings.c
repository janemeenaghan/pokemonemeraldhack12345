...
const u8 gText_Pokemon[] = _("ANIMALS");
...
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “ANIMALS.”{PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? ANIMALS");
const u8 gText_UnkHeight[] = _("{CLEAR_TO 0x0C}??'??”");
const u8 gText_UnkWeight[] = _("????.? lbs.");
const u8 gText_EmptyPkmnCategory[] = _("                       ANIMALS"); // Unused
...
const u8 gText_NoMatchingPkmnWereFound[] = _("No matching ANIMALS were found.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for ANIMALS based on\nselected parameters.");
...
const u8 gText_DexSortNumericalDescription[] = _("ANIMALS are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned ANIMALS are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned ANIMALS are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned ANIMALS are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned ANIMALS are listed from the\ntallest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned ANIMALS are listed from the\nsmallest to the tallest.");
...
const u8 gText_HOFDexRating[] = _("Spotted ANIMALS: {STR_VAR_1}!\nOwned ANIMALS: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("PROF. BIRCH is in trouble!\nRelease a ANIMALS and rescue him!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this ANIMALS?");
const u8 gText_Pokemon4[] = _("ANIMALS"); // Unused
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild ANIMALS will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild ANIMALS will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThePokemonList[] = _("the ANIMALS LIST");
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} ANIMALS\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon2[] = _("Teach which ANIMALS?"); // Unused
const u8 gText_ChoosePokemon[] = _("Choose a ANIMALS.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which ANIMALS?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which ANIMALS?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which ANIMALS?");
...
const u8 gText_NoPokemonForBattle[] = _("No ANIMALS for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a ANIMALS.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} ANIMALS are needed.");
const u8 gText_PokemonCantBeSame[] = _("ANIMALS can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose ANIMALS or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose ANIMALS and confirm.");
...
const u8 gText_PkmnCantParticipate[] = _("That ANIMALS can't participate.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That ANIMALS can't be traded\nnow.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other TRAINER's ANIMALS\ncan't be traded now.");
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of ANIMALS\nthat the other TRAINER wants.");
...
const u8 gText_RentalPkmn[] = _("RENTAL ANIMALS");
...
const u8 gText_PkmnInfo[] = _("ANIMALS INFO");
const u8 gText_PkmnSkills[] = _("ANIMALS SKILLS");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd ANIMALS EGG found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar ANIMALS EGG\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar ANIMALS EGG\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A ANIMALS EGG obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd ANIMALS EGG\nobtained from a traveler.");
...
const u8 gText_MenuOptionPokemon[] = _("ANIMALS");
...
const u8 gText_PokemonJump[] = _("ANIMALS JUMP");
...
const u8 gText_PokemonNature[] = _("ANIMALS NATURE");
const u8 gText_PokemonMoves[] = _("ANIMALS MOVES");
const u8 gText_Underpowered[] = _("UNDERPOWERED");
const u8 gText_WhenInDanger[] = _("WHEN IN DANGER");
const u8 gText_PyramidPokemon[] = _("PYRAMID: ANIMALS");
...
const u8 gText_PokemonOrder[] = _("ANIMALS ORDER");
const u8 gText_BattlePokemon[] = _("BATTLE ANIMALS");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this ANIMALS?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0}!");
const u8 gText_MarkYourPkmn[] = _("Mark your ANIMALS.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last ANIMALS!");
const u8 gText_YourPartysFull[] = _("Your party's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a ANIMALS!");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a ANIMALS?");
...
const u8 gText_WithdrawPokemon[] = _("WITHDRAW ANIMALS");
const u8 gText_DepositPokemon[] = _("DEPOSIT ANIMALS");
const u8 gText_MovePokemon[] = _("MOVE ANIMALS");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("Move ANIMALS stored in BOXES to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store ANIMALS in your party in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organize the ANIMALS in BOXES and\nin your party.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any ANIMALS\nin a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("Return to the previous menu.");
const u8 gText_JustOnePkmn[] = _("There is just one ANIMALS with you.");
...
const u8 gText_CheckPokemonInDetail[] = _("Check ANIMALS in detail.");
...
const u8 gText_CheckPartyPokemonInDetail[] = _("Check party ANIMALS in detail.");
const u8 gText_CheckAllPokemonInDetail[] = _("Check all ANIMALS in detail.");
const u8 gText_ReturnToPokenavMenu[] = _("Return to the POKéNAV menu.");
const u8 gText_FindCoolPokemon[] = _("Find cool ANIMALS.");
const u8 gText_FindBeautifulPokemon[] = _("Find beautiful ANIMALS.");
const u8 gText_FindCutePokemon[] = _("Find cute ANIMALS.");
const u8 gText_FindSmartPokemon[] = _("Find smart ANIMALS.");
const u8 gText_FindToughPokemon[] = _("Find tough ANIMALS.");
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("TRAINER'S ANIMALS");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the ANIMALS MAIL?");
...
const u8 gText_StopGivingPkmnMail2[] = _("Stop giving the ANIMALS MAIL?"); // Unused
...
const u8 gText_PokemonLeague[] = _("ANIMALS LEAGUE");
const u8 gText_PokemonCenter[] = _("ANIMALS CENTER");
...
const u8 gText_PokemonTrades[] = _("ANIMALS TRADES");
...
const u8 gText_Pokemon2[] = _("ANIMALS");
...
const u8 gText_MatchCallSteven_Pokemon[] = _("Ultimate STEEL ANIMALS.");
...
const u8 gText_MatchCallBrendan_Pokemon[] = _("I will use various ANIMALS.");
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better ANIMALS");
...
const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any ANIMALS!");
const u8 gText_MatchCallMay_Intro1[] = _("My ANIMALS and I help");
...
const u8 gText_BattlePalaceDesc[] = _("Watch your ANIMALS battle!\nYour spirit will be tested.");
const u8 gText_BattleArenaDesc[] = _("Win battles with teamed-up ANIMALS!\nYour guts will be tested.");
const u8 gText_BattleFactoryDesc[] = _("Aim for victory using rental ANIMALS!\nYour knowledge will be tested.");
...
const u8 gText_PkmnJumpRecords[] = _("ANIMALS JUMP RECORDS");
...
const u8 gText_MenuPokemon[] = _("ANIMALS");
...
const u8 gText_PokemonOnHook[] = _("A ANIMALS's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("ANIMALS");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("ANIMALS2");
...
const u8 gText_RentalPkmn2[] = _("RENTAL ANIMALS");
const u8 gText_SelectFirstPkmn[] = _("Select the first ANIMALS.");
const u8 gText_SelectSecondPkmn[] = _("Select the second ANIMALS.");
const u8 gText_SelectThirdPkmn[] = _("Select the third ANIMALS.");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three ANIMALS OK?");
const u8 gText_Yes2[] = _("YES");
const u8 gText_No2[] = _("NO");
const u8 gText_CantSelectSamePkmn[] = _("Can't select same {PKMN}.");
const u8 gText_PkmnSwap[] = _("ANIMALS SWAP");
const u8 gText_SelectPkmnToSwap[] = _("Select ANIMALS to swap.");
const u8 gText_SelectPkmnToAccept[] = _("Select ANIMALS to accept.");
...
const u8 gText_AcceptThisPkmn[] = _("Accept this ANIMALS?");
